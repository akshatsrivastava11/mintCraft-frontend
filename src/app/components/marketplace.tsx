...
function MarketplacePage() {
  const [nfts, setNfts] = useState<NFTListing[]>(mockNFTs)
  const [filteredNfts, setFilteredNfts] = useState<NFTListing[]>(mockNFTs)
    ...
    <div className="min-h-screen bg-white/90 backdrop-blur-sm">
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card className="bg-lime-400 brutalist-border brutalist-shadow">
          ...
          <Card className="bg-cyan-400 brutalist-border brutalist-shadow">
            <CardContent className="p-4 text-center">
              <div className="w-8 h-8 bg-black brutalist-border mx-auto mb-2 flex items-center justify-center">
          ...
          <Card className="bg-yellow-400 brutalist-border brutalist-shadow">
            <CardContent className="p-4 text-center">
              <div className="w-8 h-8 bg-black brutalist-border mx-auto mb-2 flex items-center justify-center">
                <TrendingUp className="w-4 h-4 text-yellow-400" />
              </div>
              <p className="text-2xl font-black text-black">89.2</p>
              <p className="brutalist-text text-black text-xs">SOL VOLUME</p>
            </CardContent>
          </Card>

          <Card className="bg-red-500 brutalist-border brutalist-shadow">
            <CardContent className="p-4 text-center">
              <div className="w-8 h-8 bg-black brutalist-border mx-auto mb-2 flex items-center justify-center">
                <Star className="w-4 h-4 text-red-500" />
              </div>
              <p className="text-2xl font-black text-white">4.8</p>
              <p className="brutalist-text text-white text-xs">AVG RATING</p>
            </CardContent>
          </Card>
        </div>
              ...
              <DropdownMenuContent className="bg-white brutalist-border brutalist-shadow">
                ...
                <DropdownMenuRadioGroup value={selectedCategory} onValueChange={setSelectedCategory}>
                  {categories.map((category) => (
                    <DropdownMenuRadioItem key={category} value={category} className="hover:bg-lime-400 brutalist-text">
                      {category}
                    </DropdownMenuRadioItem>
                  ))}
                </DropdownMenuRadioGroup>
            ...
            >
              ...
              <CardContent className="p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button onClick={() => handleBuy(nft.id)} className="brutalist-button-electric px-4 py-2 text-xs">
        ...
        {filteredNfts.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="brutalist-text text-gray-600">TRY ADJUSTING YOUR FILTERS OR SEARCH TERMS</p>
          </div>
        )}
      </div>
    </div>
